...
body {
	font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, 'sans-serif'"Segoe UI",Arial, sans-serif; 
	font-size: 18px;
	width:1024;
	padding:1em;
	margin:0;
...
thead {
	border-top: 1px solid #FFFFFF der-bottom: 1px solid #FF7F7F ;
...
<div id="top">
   <?php if($allow_create_folder): ?>
	<form action="?" method="post" id="mkdir" />
		<label for=dirname>Create A Directory</label><input id=dirname type=text name=name value="" />
...
?>
<a href="logout.php" class="button1">Log Out</a></p>
<footer>
